...
@section('content')
    ...
    <section id="barbers">
        <div class="barber-container">
            ...
            <div class="barber-image" id="second-barber">
                <img src="{{ asset('images/home/andrea-miserendino.webp') }}" alt="Foto di Andrea Miserendino, barbiere" loading="lazy">
            </div>
        </div>
        <div class="barber-container">
            <div class="barber-image" id="second-barber">
    ...
    <section id="services">
        ...
        <div id="services-container">
            ...
            <div>
                <img src="https://www.onhair.men/wp-content/uploads/2023/01/BARBA.jpg" alt="" loading="lazy">
                <h3>Barba</h3>
            ...
            <div>
                <img src="https://www.onhair.men/wp-content/uploads/2023/01/percorsi-relax.jpg" alt="" loading="lazy">
            ...
            <div>
                <img src="https://www.onhair.men/wp-content/uploads/2023/01/THEOS.jpg" alt="" loading="lazy">
                <h3>Theos</h3>
